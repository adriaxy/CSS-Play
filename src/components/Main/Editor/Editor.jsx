...
export default function Editor (){
  const {viewSolution, setViewSolution, sublevelState, setSublevelState, currentLevel, currentSublevel} = useGame();
  const levelRoot = levels[currentLevel];
  const sublevelRoot = levelRoot.sublevels[currentSublevel];
  const sublevelName = sublevelRoot.name;
  const sublevelNumber = sublevelRoot.id;
  const sublevelChallenge = sublevelRoot.challenge
