...
const BLOCK_COLORS = {
  ...
  'font-family':      ['#00bcd4', '#e91e8c'],
  'font-size':        ['#ff7043', '#7c4dff'],
  'font-weight':      ['#f44336', '#546e7a'],
  'line-height':      ['#66bb6a', '#66bb6a'],
  'text-align':       ['#ba68c8', '#ba68c8'],
  'border':           ['#00ff00', '#ff69b4'],
  'border-radius':    ['#00ffff', '#ffff00'],
  'outline':          ['#a0522d', '#00bfff'],
  'box-shadow':       ['#008000', '#ff0000'],
  'padding':          ['#ff0000', '#008000'],
  'margin':           ['#ab47bc', '#ab47bc'],
  'width':            ['#4f9de8', '#e8734f'],
  'height':           ['#8b5cf6', '#10b981'],
  'display':          ['#ec4899', '#3b82f6'],
  'position':         ['#6366f1', '#6366f1'],
  'overflow':         ['#ef5350', '#26a69a'],
