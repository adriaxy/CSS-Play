...
export default function LogoButton(){
    return (
        <Link href={'/play'} aria-label="CSS Play - Go to home">
            <div className='header__left'>
                    <div className='header__logo'>
                        ...
                        <svg className="header__logo-svg" width="18" height="20" viewBox="0 0 16 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
